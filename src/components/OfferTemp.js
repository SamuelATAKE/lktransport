                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="offers_image_container">
                                        ...
                                        <div class="offers_image_background bg-offer_1"></div>
                                    ...
                                    <div class="offers_content">
                                        ...
                                        <div class="offers_icons">
                                            <ul class="offers_icons_list">
                                                <li class="offers_icons_item"><img src="../../public/assets/images/post.png" alt="" /></li>
                                                <li class="offers_icons_item"><img src="../../public/assets/images/compass.png" alt="" /></li>
                                                <li class="offers_icons_item"><img src="../../public/assets/images/bicycle.png" alt="" /></li>
                                                <li class="offers_icons_item"><img src="../../public/assets/images/sailboat.png" alt="" /></li>
                                            </ul>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="offers_image_container">
                                        ...
                                        <div class="offers_image_background bg-offer_2"></div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="offers_image_container">
                                        ...
                                        <div class="offers_image_background bg-offer3"></div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="offers_image_container">
                                        ...
                                        <div class="offers_image_background bg-offer4"></div>
